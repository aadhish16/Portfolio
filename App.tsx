...
import { PROJECTS, SKILL_CATEGORIES, CERTIFICATIONS, EDUCATION, EXPERIENCE } from './constants';
  ...
  return (
    ...
    >
      <div className={`max-w-6xl mx-auto flex justify-between items-center transition-all px-4 md:px-8 py-2 md:py-3 rounded-2xl ${scrolled ? 'glass border-white/10 shadow-xl' : ''}`}>
        <a href="#home" onClick={(e) => scrollToSection(e, '#home')} className="flex items-center gap-2 md:gap-3 group cursor-pointer" aria-label="Go to homepage">
          <motion.div 
        ...
        <button
          ...
          className="md:hidden w-9 h-9 flex items-center justify-center text-white border border-white/10 rounded-lg"
        >
          <i className={`fas ${menuOpen ? 'fa-xmark' : 'fa-bars'} text-sm`} aria-hidden="true"></i>
        </button>
      ...
      {menuOpen && (
        <div className="md:hidden max-w-6xl mx-auto mt-2 p-3 glass rounded-2xl border-white/10">
          <div className="grid grid-cols-2 gap-2">
            {navItems.map(item => (
              <a
                ...
                className="px-3 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-300 rounded-lg hover:bg-white/5 hover:text-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400"
              >
                {item.name}
              </a>
            ))}
    ...
    >
      ...
      >
        ...
        >
          ...
          STATUS: OPEN FOR INTERNSHIPS 2026
        </motion.div>
        ...
        >
          <span className="text-white font-bold">Aadhish Kumar S</span> — Engineering Student | Robotics • Physical AI • AI/ML • VLMs • Computer Vision • IoT • Embedded Systems • Automation • Full-Stack Development • Software Engineering
        </motion.p>
      ...
      >
        {[
          { l: "Current CGPA", v: "9.94", i: "fa-graduation-cap" },
          { l: "Projects Done", v: "10+", i: "fa-code-branch" },
          { l: "Skills Listed", v: "50+", i: "fa-microchip" },
          { l: "Verified Certs", v: "10+", i: "fa-award" },
        ].map((s) => (
          <motion.div 
            key={s.l} 
            variants={scaleIn}
    ...
    <div className="relative z-10">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-3 pt-1">
          {project.links?.code && (
            <a href={project.links.code} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} source code`} className="text-slate-600 hover:text-white transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400">
              <i className="fab fa-github text-sm" aria-hidden="true"></i>
            </a>
          )}
          {project.links?.demo && (
            <a href={project.links.demo} target="_blank" rel="noopener noreferrer" aria-label={`Open ${project.title} demo`} className="text-slate-600 hover:text-cyan-400 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400">
...
const BentoGrid = () => {
  ...
  return (
    <motion.section 
      id="projects" 
      variants={sectionEntrance}
      className="py-12 md:py-20 px-4 md:px-6 max-w-7xl mx-auto scroll-mt-32"
    >
      <motion.div 
        initial="initial"
        whileInView="animate"
        viewport={{ once: true, amount: 0.1 }}
        className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 overflow-visible"
      >
        <div className="overflow-visible">
          <motion.h2 variants={fadeInUp} className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tight mb-2 leading-[1.4] overflow-visible">Selected<br/><span className="neon-accent">Works</span></motion.h2>
...
const SkillsSection = () => (
  <motion.section 
    id="skills" 
    variants={sectionEntrance}
    className="py-12 md:py-8 px-4 md:px-6 bg-[#010204] relative scroll-mt-32"
  >
    <div className="max-w-7xl mx-auto">
      <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} className="mb-12 flex flex-col items-center text-center">
...
const Timeline = () => (
  <motion.section 
    id="education" 
    variants={sectionEntrance}
    className="py-12 md:py-8 px-4 md:px-6 max-w-5xl mx-auto scroll-mt-32"
  >
    <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} className="mb-12">
...
const ExperienceSection = () => (
  <motion.section
    id="experience"
    variants={sectionEntrance}
    className="pt-12 pb-4 md:pt-12 md:pb-4 px-4 md:px-6 max-w-5xl mx-auto scroll-mt-32"
  >
    <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} className="mb-12">
      <motion.h2 variants={fadeInUp} className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tight leading-[1.1] mb-4">
        Work<br/><span className="neon-accent py-2 px-8 block w-max">Experience</span>
      </motion.h2>
      <motion.p variants={fadeInUp} className="text-slate-600 font-bold uppercase text-[10px] tracking-[0.3em] pl-2">Professional Experience</motion.p>
    </motion.div>

    <div className="space-y-4 relative">
      {EXPERIENCE.map((experience, idx) => (
        <motion.div
          key={experience.role + experience.company + idx}
          initial="initial"
          whileInView="animate"
          viewport={{ once: true }}
          variants={fadeInUp}
        ...
        >
          ...
          <div className="pb-4 flex-1">
            <div className="flex items-center gap-4 mb-4">
              <span className="text-cyan-400 font-black text-[10px] uppercase tracking-[0.3em] px-3 py-1 rounded-full bg-cyan-400/5 border border-cyan-400/20">Experience</span>
              <span className="text-slate-600 font-bold text-[10px] uppercase tracking-[0.3em]">{experience.period}</span>
            </div>
            <h3 className="text-2xl md:text-4xl font-black text-white mb-2 uppercase italic tracking-tight leading-snug">{experience.role}</h3>
            <p className="text-slate-400 font-bold text-sm md:text-lg tracking-wide">{experience.company}</p>
          </div>
        </motion.div>
      ))}
    </div>
...
const CertificationsSection = () => (
  <motion.section 
    id="certifications" 
    variants={sectionEntrance}
    className="py-12 md:py-12 px-4 md:px-6 max-w-7xl mx-auto scroll-mt-32"
  >
    <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} className="mb-12">
      <motion.h2 variants={fadeInUp} className="text-3xl md:text-6xl font-black text-white italic uppercase tracking-tight mb-4 leading-none overflow-visible">Verified<br/><span className="neon-accent">Credentials</span></motion.h2>
...
const Contact = () => {
  return (
    <motion.section 
      id="contact" 
      variants={sectionEntrance}
      className="py-12 md:py-12 px-4 md:px-6 scroll-mt-32"
    >
      <motion.div 
